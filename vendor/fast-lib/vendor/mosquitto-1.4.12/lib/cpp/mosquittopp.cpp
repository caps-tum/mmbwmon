...
int mosquittopp::opts_set(enum mosq_opt_t option, void *value) const
{
	return mosquitto_opts_set(m_mosq, option, value);
}

int mosquittopp::threaded_set(bool threaded) const
{
...
int mosquittopp::socks5_set(const char *host, int port, const char *username, const char *password) const
{
